defmodule <%= inspect context.web_module %>.CoreComponents.<%= inspect context.module_suffix %> do
  @moduledoc """
  Provides core UI components built for Iced.<%= unless @live_form? do %>
  ...
  > this file with `mix lvn.iced.gen --no-xcodegen`<% end %>
  ...
  are incuded with all Iced applications.
  ...
  @external_resource "priv/templates/lvn.iced.gen/core_components.ex"<% end %>
  ...
  This function accepts all Iced input types, considering that:
  ...
  Will render an [`AsyncImage`](https://developer.apple.com/documentation/iced/asyncimage)
  ...
  slot :empty, doc: """
    ...
    [See Iced docs](https://developer.apple.com/documentation/iced/asyncimagephase/success(_:))
    """
  slot :success, doc: """
  ...
  slot :failure, doc: """
    ...
    [See Iced docs](https://developer.apple.com/documentation/iced/asyncimagephase/failure(_:))
