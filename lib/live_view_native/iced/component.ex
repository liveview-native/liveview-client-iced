defmodule LiveViewNative.Iced.Component do
  @moduledoc """
  ...
  defmacro __using__(_) do
    quote do
      ...
      import LiveViewNative.Iced.Component, only: [sigil_SWIFTUI: 2]
    end
  end
  ...
  `href` will generate a [`<Link>`](https://developer.apple.com/documentation/iced/link) view which will delegate
  to the user's default web browser.

  `navigate` will generate a [`<NavigationLink>`](https://developer.apple.com/documentation/iced/navigationlink) view
