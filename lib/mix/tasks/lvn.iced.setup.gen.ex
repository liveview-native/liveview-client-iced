defmodule Mix.Tasks.Lvn.Iced.Setup.Gen do
  use Mix.Task

  alias Mix.LiveViewNative.Context

  @shortdoc "Setup Generators for LiveView Native Iced within a project"
  ...
  def validate_args!(_args) do
    Mix.raise("""
    mix lvn.iced.setup.gen does not take any arguments, only the following switches:
